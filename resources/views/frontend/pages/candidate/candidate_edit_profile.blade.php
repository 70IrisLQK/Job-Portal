                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-group">
                                    <img src="{{ asset('upload/candidates/' . $getProfile->image) }}" alt=""
                                        class="user-photo" id="show_image" />
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <input type="text" value="{{ $getProfile->name }}" name="name"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <input type="text" value="{{ $getProfile->description }}" name="description"
                                        class="form-control" placeholder="Example: Expert PHP and Laravel Developer" />
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <input type="text" value="{{ $getProfile->email }}" name="email"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <input type="text" value="{{ $getProfile->phone }}" name="phone"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <input type="text" value="{{ $getProfile->country }}" name="country"
                                        class="form-control" placeholder="Example: Canada" />
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="">Address *</label>
                                <div class="form-group">
                                    <input type="text" value="{{ $getProfile->address }}" name="address"
                                        class="form-control" placeholder="Example: 34, MKC Street" />
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="">State *</label>
                                <div class="form-group">
                                    <input type="text" value="{{ $getProfile->state }}" name="state"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <input type="text" value="{{ $getProfile->city }}" name="city"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <input type="text" value="{{ $getProfile->zip_code }}" name="zip_code"
                                        class="form-control" placeholder="Example: 32432" />
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
