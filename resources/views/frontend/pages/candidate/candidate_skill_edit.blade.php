            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12">
                    <a href="{{ route('skill.index') }}" class="btn btn-primary btn-sm mb-2"><i class="fas fa-plus"></i> See
                        All</a>
                    <form action="{{ route('skill.update', [$getSkill->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-group">
                                    <input type="text" value="{{ $getSkill->skill_name }}" name="skill_name"
                                        class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-group">
                                    <input type="number" max="100" value="{{ $getSkill->percentage }}"
