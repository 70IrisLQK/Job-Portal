                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('upload/avatars/' . $getCandidateResume->image) }}" alt=""
                                        class="w-100" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Designation:</th>
                                <td>{{ $getCandidateResume->description }}</td>
                            </tr>
                            <tr>
                                <th>Email:</th>
                                <td>{{ $getCandidateResume->email }}</td>
                            </tr>
                            <tr>
                                <th>Phone:</th>
                                <td>{{ $getCandidateResume->phone }}</td>
                            </tr>
                            <tr>
                                <th>Country:</th>
                                <td>{{ $getCandidateResume->country }}</td>
                            </tr>
                            <tr>
                                <th>Address:</th>
                                <td>{{ $getCandidateResume->address }}</td>
                            </tr>
                            <tr>
                                <th>State:</th>
                                <td>{{ $getCandidateResume->state }}</td>
                            </tr>
                            <tr>
                                <th>City:</th>
                                <td>{{ $getCandidateResume->city }}</td>
                            </tr>
                            <tr>
                                <th>Zip Code:</th>
                                <td>{{ $getCandidateResume->zip_code }}</td>
                            </tr>
                            <tr>
                                <th>Gender:</th>
                                <td>
                            ...
                            <tr>
                                <th>Date of Birth:</th>
                                <td>{{ $getCandidateResume->date_of_birth }}</td>
                            </tr>
                            <tr>
                                <th>Website:</th>
                                <td>{{ $getCandidateResume->website }}</td>
                            </tr>
                            <tr>
                                <th>Biography:</th>
                                <td>
                                    {!! $getCandidateResume->bio !!}
                                </td>
                            </tr>
                        </table>
                    </div>
