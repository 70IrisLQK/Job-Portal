                                    ...
                                    <tbody>
                                        @foreach ($listLocations as $key => $location)
                                            <tr>
                                                ...
                                                <td>{{ $location->name }}</td>
                                                <td>
                                                    <button location="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#exampleModal{{ $location->id }}">
                                                        View Detail
                                                    </button>
                                                </td>
                                                <td class="pt_10 pb_10 d-flex">
                                                    <a href="{{ route('company-locations.edit', [$location->id]) }}"
                                                        class="btn btn-success">Update</a>
                                                    <form action="{{ route('company-locations.destroy', [$location->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <button location="button" class="btn-close"
                                                            ...
                                                            <div class="modal-footer">
                                                                <button location="button" class="btn btn-secondary"
